#
# build.tcl: Tcl script for re-creating project 'tebf0808_qgige'
#
#*****************************************************************************************
...
set design_name tebf0808_qgige
...
# Create project
create_project $design_name $origin_dir/$design_name -part xczu9eg-ffvc900-1-e
...
set file "[file normalize "$origin_dir/src/constraints/tebf0808.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/tebf0808.xdc"
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/src/constraints/tebf0808.xdc"]" $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu9eg-ffvc900-1-e -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu9eg-ffvc900-1-e -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
