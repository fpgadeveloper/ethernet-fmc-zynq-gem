#
# build.tcl: Tcl script for re-creating project 'zcu102_hpc0_qgige'
#
#*****************************************************************************************
...
set orig_proj_dir "[file normalize "$origin_dir/zcu102_hpc0_qgige"]"

# Create project
create_project zcu102_hpc0_qgige $origin_dir/zcu102_hpc0_qgige -part xczu9eg-ffvb1156-1-i-es1

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects zcu102_hpc0_qgige]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/src/constraints/zcu102-rgmii-hpc0.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/zcu102-rgmii-hpc0.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property "file_type" "XDC" $file_obj
...
puts "INFO: Project created:zcu102_hpc0_qgige"
