#
# build.tcl: Tcl script for re-creating project 'uz_pci_qgige'
#
#*****************************************************************************************

# Check the version of Vivado used
set version_required "2017.4"
...
# Create project
create_project $design_name $origin_dir/$design_name -part xczu3eg-sfva625-1-i
...
set_property -name "board_part" -value "em.avnet.com:ultrazed_eg_pciecc_production:part0:1.0" -objects $obj
...
set file "[file normalize "$origin_dir/src/constraints/uzeg-pci.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/uzeg-pci.xdc"
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/src/constraints/uzeg-pci.xdc"]" $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xczu3eg-sfva625-1-i -flow {Vivado Synthesis 2017} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xczu3eg-sfva625-1-i -flow {Vivado Implementation 2017} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
...
# Create block design
source $origin_dir/src/bd/design_1-uzeg.tcl
