#
# build.tcl: Tcl script for re-creating project 'pynqzu_qgige'
#
#*****************************************************************************************
...
# Set FPGA part
set fpga_part "xczu5eg-sfvc784-1-e"
...
set file "[file normalize "$origin_dir/src/constraints/pynqzu.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/pynqzu.xdc"
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/src/constraints/pynqzu.xdc"]" $obj
